...
import { Button, Table, Divider ,Select, Input, Popconfirm, Tooltip, Tag } from 'antd'
...
class Product extends Component {
    ...
    render() {
        ...
        const columns = [
          ...
          { title: '服务价格(元)',width: '120px', dataIndex: 'price', align: 'center', render: (text, record) => {
            if(text === 0) {
                return '免费'
            }else if(text === -1) {
                return '面议'
          ...
          { title: '服务状态',width: '120px', dataIndex: 'y', align: 'center', render: (text, record) => {
            if(record.state === 1) {
            ...
            <div>
                {
                   ...
                   <Button type="primary" onClick={this.toAdd} style={{margin: '10px'}}>新增</Button>
                    ...
                    <div style={{margin: '5px 15px 0 15px'}}>服务状态</div> 
                    <Select
